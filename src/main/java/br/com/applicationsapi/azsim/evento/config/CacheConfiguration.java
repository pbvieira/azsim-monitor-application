...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("monitorEventosAzSim");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("monitorEventosAzSim");
        ...
        config.getMapConfigs().put("br.com.applicationsapi.azsim.evento.domain.*", initializeDomainMapConfig(jHipsterProperties));
